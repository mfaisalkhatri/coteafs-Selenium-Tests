...
public class OrderPage extends BrowserPage {
	...
	public IMouseActions productPrice () {
		return this.onClickable (By.cssSelector ("#our_price_display"), "Product Price");
	}
	...
	public ITextboxActions quantity () {
		return this.onTextbox (By.id ("quantity_wanted"), "Quantity");
	}
	...
	public ISelectboxActions size () {
		return this.onDropdown (By.id ("group_1"), "Size");
	}
	...
	public IMouseActions orangeColor () {
		return this.onClickable (By.id ("color_13"), "Orange Color");
	}
	...
	public IMouseActions blueColor () {
		return this.onClickable (By.id ("color_14"), "Blue Color");
	}
}
